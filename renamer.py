...
def clean_name(path):
    remove_keys = ["BDRip", "SiMPLE", "BRRip", "HD-TS", "HC", "HEVC", "WEBRip", "HDDVD", "VPPV", "HQ", "DTS", "Hive-CM8", "mp4", "mp3", "NEW SOURCE", "Extended", "LIMITED", "XviD", "H264", "x265", "AC3", "DVDSCR", "720P", "1080P", "HDRip", "DVDRip", "x264", "AAC", "6CH", "BluRay", "-ETRG", "WEB-DL", "WEBDL", "DD5", "-EVO", "-AMIABLE", "-JYK", "-iNFAMOUS", "-ALLiANCE", "-HANDJOB", "-FUM", "-EXTREME", "-FGT", "-POOP", "-PSA", "Feel-Free", "-Ozlem", "- EVO", "- AMIABLE", "- JYK", "- iNFAMOUS", "- ALLiANCE", "- HANDJOB", "- FUM", "- EXTREME", "- FGT", "- POOP", "- PSA", "-Feel-Free", "- Ozlem", "- ETRG", "-PTpOWeR", "- PTpOWeR", "-CODY", "- CODY", "-.Hon3y", "- .Hon3y", "-XvAvX", "- XvAvX", "-RARBG", "- RARBG", "-CM8", "- CM8", "-aNaRCHo", "- aNaRCHo", "TommieCook", "-VLiS", "- VLiS", "_sujaidr", "anoXmous", "FRENCH", "JAPANESE", "-SPARKS", "- SPARKS", "-MAXSPEED", "- MAXSPEED", "-Exclusive", "- Exclusive", "- WeTv", "-WeTv", "-aXXo", "- aXXo", "Ganool", "- iExTV", "-iExTV", "NVEE", "-MAJESTiC", "- MAJESTiC", "Netflix", "-Garmin", "- Garmin", "Final Cut", "-T0XiC-iNK"]
